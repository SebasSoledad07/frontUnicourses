...
const TeacherLayout = () => {
  ...
  // Detectar si estamos en una vista de detalle de curso
  const isInCourseDetail =
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      >
        <div className="p-6">
          {/* Breadcrumb / botón volver (opcional) */}
          {isInCourseDetail && (
            <button
              onClick={() => navigate("/teacher/courses")}
              className="mb-4 inline-flex items-center gap-2 text-sm text-gray-600 hover:text-teal-600 transition-colors"
            >
              <svg
                className="w-4 h-4"
                fill="none"
