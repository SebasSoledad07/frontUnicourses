  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (error) {
        ...
        onSuccess(nombre); // ✅ Esto cierra el modal y muestra el toast
      }
    } catch (err) {
      console.error(err);
      ...
      <div className="bg-white rounded-2xl shadow-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-4 sticky top-0">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={onClose} // ✅ Ya funcionaba, pero asegúrate que no esté disabled
              type="button" // ✅ Agregado type="button" para que no haga submit
              className="text-white hover:bg-white/20 rounded-lg p-1 transition-colors flex-shrink-0" // ✅ Agregado flex-shrink-0
            >
              <svg
                className="w-6 h-6"
                fill="none"
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                disabled={loading}
                className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors disabled:bg-gray-50"
          ...
          <div>
            ...
            <textarea
              ...
              disabled={loading}
              rows={4}
              className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors disabled:bg-gray-50 resize-none"
              ...
              <div className="flex items-center gap-3">
                <div
                  className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                    activo ? "bg-green-100" : "bg-gray-200"
                  }`}
                >
                  <svg
                    className={`w-6 h-6 ${
                ...
                <div>
                  <p className="font-medium text-gray-900">Estado del curso</p>
                  <p className="text-sm text-gray-600">
                    {activo
                      ? "El curso está visible para estudiantes"
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              type="submit" // ✅ IMPORTANTE: type="submit" para que ejecute handleSubmit
              disabled={loading}
              className={`
